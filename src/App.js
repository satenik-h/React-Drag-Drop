...
const onChange = (_, sourceIndex, targetIndex) => {
  if(sourceIndex < items.length && targetIndex < items.length) {
    if (confirm(`Do you want to replace Image ${items[targetIndex].id} for image ${items[sourceIndex].id} ?`)) {
